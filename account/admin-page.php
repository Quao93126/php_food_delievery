      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <!-- <h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/logo.png"
                      alt="logo"></a> <span class="logo-text">Logo</span></h1> -->
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i>
                Users</a>
            </li>
          </ul>
        ...
        <section id="content">
          ...
          <div class="container">
                ...
                <div>
                  <table id="data-table-admin" class="responsive-table display" cellspacing="0">
					...
					<img style="width:200px; height:180px;" src="data:image/jpeg;base64,' . base64_encode($row['image']) . '" id="' . $row["id"] . '_image" name="' . $row['id'] . '_image" type="file" data-error=".errorTxt' . $row["id"] . '"><div class="errorTxt' . $row["id"] . '"></div>
                        ...
                        echo '<td><div class="input-field col s12"><label for="' . $row["id"] . 'catetory_name">Name</label>';
                        echo '<input value="' . $row["catetory_name"] . '" id="' . $row["id"] . 'catetory_name" name="' . $row['id'] . 'catetory_name" type="text" data-error=".errorTxt' . $row["id"] . '"><div class="errorTxt' . $row["id"] . '"></div></td></tr>';
                      }
                      ?>
                    </tbody>
                  </table>
            ...
            <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php"
                ...
                <div>
                  <table>
                    ...
                    <tbody>
                      ...
                      echo '<td>';
                      echo '<td><div class="input-field col s12 "><label for="category" class="">Category</label>';
                      echo '<input id="category" name="category" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td></tr>';
                      ?>
                    </tbody>
                  </table>
                </div>
