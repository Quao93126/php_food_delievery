<?php 
	...
	if(!isset($_SESSION['room']))
	{
		...
		$sql = "CREATE TABLE `food`.`$room` ( `sn` INT(128) NOT NULL AUTO_INCREMENT , `username` VARCHAR(128) NOT NULL , `dp` VARCHAR(128) NOT NULL,  `msg` VARCHAR(128) NOT NULL , `date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`sn`)) ENGINE = InnoDB;";
...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				<img id="profile-img" src="<?php echo $folder; ?>" class="online" alt="img" />
				...
				<div id="expanded">
					...
					<input name="email" readonly type="text" value="<?php echo $_SESSION['name']; ?>" />
		...
		<div id="bottom-bar">
			...
			<button id="settings"><a href="index.php" style="text-decoration:none; color:white;" >
				<i class="fa fa-cog fa-fw" aria-hidden="true"></i> <span>Order Now</span></a>
			</button>
		</div>
	</div>
	<div class="content">
