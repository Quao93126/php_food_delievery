        ...
        <nav class="navbar-color">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
              <li><a href="#" class="waves-effect waves-block waves-light"><i
                    class="mdi-editor-attach-money"><?php echo $balance; ?></i></a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
                  ...
                  <div class="collapsible-body">
                    <ul>
                      <li><a href="tickets.php">All Offers</a></li>
                      <?php
            ...
            <li class="bold"><a href="hatDisplay.php" class="waves-effect waves-cyan"><i
                  class="mdi-content-inbox"></i>Inbox</a>
            </li>
                  ...
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        echo '<tr><td>' . $row["name"] . '</td><td><img style="width:200px;height:180px;" src="data:image/jpeg;base64,' . base64_encode($row['image']) . '" id="' . $row["id"] . '_image" name="' . $row['id'] . '_image" type="file" data-error=".errorTxt' . $row["id"] . '"></td><td>' . $row["price"] . '</td>';
